...
def run_tool3_tests(resolved: list[dict]) -> dict:
    ...
    scenarios = [
        {
            # Theraflu = 1000mg acetaminophen/dose. 4 doses = 4000mg > 3000mg limit.
            # More reliable than NyQuil which has multiple formulations in OpenFDA.
        ...
        {
            # Theraflu (x2) = 2000mg + Tylenol (x3) = 1500mg → 3500mg > 3000mg
        ...
        {
            # Aleve (x2) = 440mg > 660mg limit? No. But (x4) would be.
            # Real test: naproxen at x4 = 880mg which does exceed 660mg OTC limit.
            "label": "Advil (x3) + Aleve (x4) — should flag naproxen over limit",
